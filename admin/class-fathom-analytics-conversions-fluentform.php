...
class Fathom_Analytics_Conversions_Fluent_Form {
	...
	public function enqueue_scripts() {
		if ( FAC_Options::get( FAC4WP_OPTION_INTEGRATE_FLUENTFORMS ) && is_fac_fathom_analytic_active() ) {
			if ( ! fac_fathom_is_excluded_from_tracking() ) { // Track visits by administrators!

				$js = 'jQuery(document).on("fluentform_submission_success", function (e, form) {
